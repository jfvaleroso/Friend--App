...
var appSettings = {
    ...
    everlive: {
        apiKey: 'OrMMXgphXHszLqe4', // Put your Everlive API key here
        scheme: 'http'
    },
    
    eqatec: {
        productKey: '68cdffbc61ea4bbd88e22c73e397e848',  // Put your EQATEC product key here
        version: '1.0.0.0' // Put your application version here
    },
    
    facebook: {
        appId: '255323991312127', // Put your Facebook App ID here
